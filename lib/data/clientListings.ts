...
export const SAVED_LISTING_COLUMNS =
  "id, slug, type, title, description, venue_id, address, neighborhood, category, date_start, date_end, date_display, time_display, is_free, deal_value, image_url, source, source_url, ticket_url, tags, lat, lng";
...
export function rowToListing(r: Record<string, unknown>): Listing {
  return {
    ...
    ticketUrl: (r.ticket_url as string) ?? undefined,
